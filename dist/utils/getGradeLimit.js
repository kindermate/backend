...
exports.getGradeLimitPBT = exports.getGradeLimitMAT = exports.getGradeLimitCTT = void 0;
function getGradeLimitCTT(tw, month, gender, part) {
    if (part === 1) {
...
exports.getGradeLimitCTT = getGradeLimitCTT;
function getGradeLimitMAT(tw, month, gender, part) {
    if (part === 1) {
        if (month >= 24 && month <= 35) {
            if (gender === 'male') {
                if (tw <= 34.31) {
...
exports.getGradeLimitMAT = getGradeLimitMAT;
function getGradeLimitPBT(tw, month, gender, part) {
    if (part === 1) {
        if (month >= 24 && month <= 35) {
            if (gender === 'male') {
                if (tw <= 35.21) {
...
exports.getGradeLimitPBT = getGradeLimitPBT;
//# sourceMappingURL=getGradeLimit.js.map